...
-- without index
SET max_parallel_workers_per_gather = 0; SET enable_seqscan = on; SET enable_bitmapscan = off; explain analyze select text from sentences where text ~ 'ho';

-- with ibpe index
SET enable_seqscan = off; explain analyze select text from sentences where text ~ 'si\.ta\.so\.ngi\.ta';
-- without index
SET max_parallel_workers_per_gather = 0; SET enable_seqscan = on; SET enable_bitmapscan = off; explain analyze select text from sentences where text ~ 'si\.ta\.so\.ngi\.ta';
